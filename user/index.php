            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="../user"><i class="fa fa-edit"></i>Pemilihan</a></li>
                </ul>
        ...
        <div class="right_col" role="main">
            <div class="">
                <div class="row top_tiles">
                    ...
                    $page = @$_GET['page'];
                    if($page == ""){
                    include"pilih_hmjka.php";
                    } else if($page =="profile"){
                    include"profile.php";
                  } else if($page =="profile_hmjka"){
                    include"profile_hmjka.php";
                  } else if($page =="profile_hmjab"){
                    include"profile_hmjab.php";
                    } else if($page =="profile_hmjab"){
                    include"profile_hmjab.php";
                    } else if($page =="profile_hmjt"){
                    include"profile_hmjt.php";
                    } elseif ($page =="profile_hima") {
                    include"profile_hima.php";
                    } elseif ($page =="dpm") {
                      include"pilih_dpm.php";
                    } elseif ($page =="use") {
                      include"use.php";
                    } else if ($page == ""){
                      include"welcome.php";
